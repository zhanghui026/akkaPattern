...
public class ShardedJedisPipeline extends Queable {
    ...
    public Response<Boolean> exists(String key) {
        ...
        c.exists(key);
        results.add(new FutureResult(c));
        return getResponse(redis.clients.jedis.BuilderFactory.BOOLEAN);
    }
    ...
    public Response<Set<String>> zrange(String key, int start, int end) {
        ...
        results.add(new FutureResult(c));
        return getResponse(redis.clients.jedis.BuilderFactory.STRING_ZSET);
    }
    ...
    public Response<Double> zincrby(String key, double score, String member) {
        ...
        results.add(new FutureResult(c));
        return getResponse(redis.clients.jedis.BuilderFactory.DOUBLE);
    }
    ...
    public Response<Set<Tuple>> zrangeWithScores(String key, int start, int end) {
        ...
        results.add(new FutureResult(c));
        return getResponse(redis.clients.jedis.BuilderFactory.TUPLE_ZSET);
    }
